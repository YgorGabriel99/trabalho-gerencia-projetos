...
export default class StatusJogador extends Phaser.GameObjects.Container {
    ...
    constructor(data: { scene: any; x: number; y: number; fundo: any; warMatch: WarMatch}) {
        ...
        super(scene,x,y ,[spriteFundoAzul,spriteElipseTurno,spriteElipseSeguranca,spriteBotaoFinalizar,spriteSeguranca,textTurnoJogador,textBotaoFinalizar,spriteLinhaertical]);
